...
Route::group(['middleware' => ['auth:web', 'role:admin'], 'prefix' => 'admin'], function () {
    ...
    Route::get('pinjaman/divisi', [RentalController::class, 'divisi'])->name('admin.rental.divisi');
    ...
    Route::post('/service/finis/{id}', [ServiceController::class, 'finis'])->name('admin.service.finis');
    //service end
