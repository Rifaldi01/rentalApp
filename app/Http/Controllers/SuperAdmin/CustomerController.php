...
class CustomerController extends Controller
{
    ...
    public function create($id = null)
    {
        ...
        if ($id){
            ...
            $inject = [
                'url' => route('superadmin.customer.update', $id),
                'customer' => $customer
            ];
        }
        return view('superadmin.customer.create', $inject);
    }
    ...
    public function show(string $id)
    {
        ...
        return view('superadmin.customer.show', compact('customer', 'rental'));
    }
    ...
    private function save(Request $request, $id = null)
    {
        ...
        return redirect()->route('superadmin.customer.index')->withSuccess('Berhasil');
    }
}
