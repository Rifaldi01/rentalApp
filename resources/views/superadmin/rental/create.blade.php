        ...
        <div class="card-body p-4">
            ...
            <form class="row g-3" action="{{$url}}" method="POST" enctype="multipart/form-data" id="myForm">
                ...
                <div class="col-md-12">
                    ...
                    <textarea value="{{isset($rental) ? $rental->date_pay : null}}" name="date_pay" class="form-control" id="input4" placeholder="Enter Descripty"></textarea>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="d-md-flex d-grid align-rentals-center gap-3">
                        ...
                        <a href="{{route('superadmin.rental.index')}}" class="btn btn-warning">Back</a>
                    </div>
                </div>
            </form>
        </div>
