            ...
            <div class="row">
                ...
                <div class="col-6">
                    <a data-bs-toggle="tooltip" data-bs-placement="top" title="Add Item"
                       href="{{route('superadmin.item.create')}}" class="btn btn-dnd float-end me-3 mt-3 btn-sm shadow"><i
                            class="bx bx-plus"></i>
                    </a>
                </div>
            </div>
                ...
                <table id="example3" class="table table-striped table-bordered" style="width:100%">
                    ...
                    <tr>
                        @foreach($item as $key => $data)
                            <td>{{$key +1}}</td>
                            <td>
                                <a href="{{route('superadmin.item.show', $data->id)}}" class="text-dark">{{$data->name}}</a>
                            </td>
                            ...
                            <td>
                                <a href="{{route('superadmin.item.destroy', $data->id)}}" data-confirm-delete="true"
                                   class="btn btn-danger btn-sm bx bx-trash float-end" data-bs-toggle="tooltip"
                                   data-bs-placement="top" title="Delete">
                                </a>
                                <a href="{{route('superadmin.item.edit', $data->id)}}"
