<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                <li>
                    <a href="{{route('superadmin.rental.create')}}"><i class='lni lni-timer'></i>Rental</a>
                </li>
                <li>
                    <a href="{{route('superadmin.rental.index')}}"><i class='bx bx-list-ul'></i>List Rental</a>
                </li>
                <li>
                    <a href="{{route('rental.history')}}"><i class='bx bx-history'></i>History Rental</a>
                </li>
                <li>
                    <a href="{{route('rental.problems')}}"><i class='lni lni-warning'></i>Problem</a>
                </li>
            </ul>
        </li>
        <li>
            ...
            <ul>
                <li><a href="{{route('superadmin.customer.create')}}"><i class='bx bx-user-plus'></i>Register
                        Customer</a>
                </li>
                <li><a href="{{route('superadmin.customer.index')}}"><i class='lni lni-users'></i>List Customers</a>
                </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul>
                <li>
                    <a href="{{route('superadmin.item.index')}}">
                        <i class='bx bx-box'></i>
                        Items
                    </a>
                </li>
                <li>
                    <a href="{{route('superadmin.cat.index')}}">
        ...
        <li>
            <a href="{{route('superadmin.acces.index')}}">
        ...
        <li>
            ...
            <ul>
                <li>
                    <a href="{{route('rental.report')}}">
                        <i class='bx bx-circle '></i>
                        Report Rental
                    </a>
                </li>
                <li>
                    <a href="{{route('problem.report')}}">
                        <i class='bx bx-circle '></i>
                        Report Problem
                    </a>
                </li>
                <li>
                    <a href="{{route('mainten.report')}}">
                        <i class='bx bx-circle '></i>
                        Report Maintenance
                    </a>
                </li>
