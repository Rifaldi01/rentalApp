                ...
                <div class="modal-body modal-surat">
                    ...
                    <div class="table-responsive mb-4">
                        <table class="" style="width:100%">
                            ...
                            <tr>
                                ...
                                <th width="1%">:</th>
                                <th>{{optional($data->divisi)->name ?? '-'}}</th>
                                <th width="1%">Perihal</th>
                                <th width="1%" class="text-end">:</th>
                                <th width="1%" class="text-end"
                                    style="border-right-width:0;">Pinjaman Barang</th>
                            </tr>
                            <tr>
                                <th>No</th>
                                <th>:</th>
                                <th>{{$data->kode_pinjaman}}</th>
                                <th width="1%" class="text-end"></th>
                                <th width="1%" class="text-end"></th>
                                <th width="1%" style="border-right-width:0;"></th>
                            </tr>
                            </thead>
                            <tbody>
                            </tbody>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            {{-- Tampilkan item hanya jika item_id tidak null dan berisi data --}}
                            ...
                            {{-- Tampilkan accessories --}}
                            @foreach($data->RentalDivisiDetail as $detail)
                                <tr>
                                    <td class="text-center">{{ $no++ }}</td>
                                    <td>{{ $detail->accessory ? $detail->accessory->name : 'Not Found' }}</td>
                                    <td>{{ $detail->qty }}</td>
                                    <td>Aksesoris</td>
                                </tr>
                            @endforeach
