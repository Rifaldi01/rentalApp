            ...
            <div class="row">
                ...
                <div class="col-6">
                    <a data-bs-toggle="tooltip" data-bs-placement="top" title="Add Item"
                       href="{{ route('employe.item.create') }}" class="btn btn-dnd float-end me-3 mt-3 btn-sm shadow">
                ...
                <table id="example4" class="table table-striped table-bordered" style="width:100%">
                    ...
                    @foreach($items as $key => $data)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('employe.item.show', $data->id) }}" class="text-dark">{{ $data->name }}</a>
                            </td>
                            ...
                            <td>
                                <a href="{{ route('employe.item.destroy', $data->id) }}" data-confirm-delete="true"
                                   class="btn btn-danger btn-sm bx bx-trash float-end" data-bs-toggle="tooltip"
                                   data-bs-placement="top" title="Delete">
                                </a>
                                <a href="{{ route('employe.item.edit', $data->id) }}"
                                ...
                                <div class="modal fade" id="exampleVerticallycenteredModal{{ $data->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('employe.mainten.store') }}" method="POST">
                                                @csrf
                                                <div class="modal-body">
                                ...
                                <div class="modal fade" id="exampleLargeModal{{ $data->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('employe.item.sale') }}" method="POST">
                                                    @csrf
                                                    <div class="modal-body">
                                                        <input value="{{ $data->id }}" type="hidden" name="item_id"
                                                               class="form-control">
